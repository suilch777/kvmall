...
public class KvproductPage {
	...
	private List<Kvproduct> content; //?쁽?옱 ?솕硫댁뿉 display ?맆 寃뚯떆?뙋 由ъ뒪?듃?궡?슜
	...
	public KvproductPage(int total, int currentPage, int size, List<Kvproduct> content) {
		this.total = total;
	...
	public List<Kvproduct> getContent() {
		return content;
	}
